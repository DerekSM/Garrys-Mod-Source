...
local m_acttable = {
	...
	[ ACT_DOD_STAND_IDLE ] = ACT_DOD_STAND_IDLE_C96,
	[ ACT_DOD_CROUCH_IDLE ] = ACT_DOD_CROUCH_IDLE_C96,
	[ ACT_DOD_CROUCHWALK_IDLE ] = ACT_DOD_CROUCHWALK_IDLE_C96,
	[ ACT_DOD_WALK_IDLE ] = ACT_DOD_WALK_IDLE_C96,
	[ ACT_DOD_RUN_IDLE ] = ACT_DOD_RUN_IDLE_C96,
...
function SWEP:Initialize()
	self:RegisterHoldType( "c96", acttable )
